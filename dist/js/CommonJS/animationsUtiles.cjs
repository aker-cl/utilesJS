 ...
 */
exports.animateValue = function animateValue(element, start, end, textBefore = '', textAfter = ''){
    let current = start;
    let step = end / 70;
    let increment = step;
 ...
 * @param {string} action
 */
exports.elementTransition = function elementTransition(element, action){
    switch (action) {
        case 'show':
 ...
 */ 
exports.loadingButton = function loadingButton(btn, action, text = null){
    switch (action) {
        case 'start':
