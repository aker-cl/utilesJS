 ...
 * @param {Object} input
 */
exports.formatRut =  function formatRut(input){
 ...
 * @param {Object} input
 */
exports.maxLengthCheck = function maxLengthCheck(input){
 ...
 */
exports.checkKeys = function checkKeys(event, validation){
    let key = event.key;
    let keys = [];
 ...
 */
exports.filterTable = function filterTable(tableId, input){
 ...
 */
exports.scrollTransition = function scrollTransition(opts){
